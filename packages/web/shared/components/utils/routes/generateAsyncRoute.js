 ...
 */
export default function generateAsyncRoute({ loader, Placeholder }) {
  let Component = null
  ...
  return class AsyncRouteComponent extends React.Component {
    ...
    static load() {
      return loader().then(ResolvedComponent => {
        ...
        // Return an instance of the Component for the server
        // The server will check the Component for any `loadData` statics
        return Component
      })
    }
